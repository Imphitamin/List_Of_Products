...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 11
 */
public class InfoScreenEleven11 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.nokia_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.nokia_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.nokia_logo);

...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 7
 */
public class InfoScreenSeven7 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.explay_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.explay_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.explay_logo);

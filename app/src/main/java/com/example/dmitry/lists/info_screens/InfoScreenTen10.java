...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 10
 */
public class InfoScreenTen10 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.huawei_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.huawei_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.huawei_logo);

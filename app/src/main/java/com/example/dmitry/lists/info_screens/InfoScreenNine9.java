...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 9
 */
public class InfoScreenNine9 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.lg_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.lg_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.lg_logo);

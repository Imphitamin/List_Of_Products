...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 6
 */
public class InfoScreenSix6 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.asus_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.asus_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.asus_logo);

...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 1
 */
public class InfoScreenOne1 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.htc_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.htc_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.htc_logotip);

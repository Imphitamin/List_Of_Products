...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 12
 */
public class InfoScreenTwelve12 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.samsung_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.samsung_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.samsung_logo);

...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 3
 */
public class InfoScreenThree3 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.apple_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.apple_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.apple_logo);

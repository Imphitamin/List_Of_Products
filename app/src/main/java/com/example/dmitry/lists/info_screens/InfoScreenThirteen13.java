...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 13
 */
public class InfoScreenThirteen13 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.sony_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.sony_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.sony_logo);

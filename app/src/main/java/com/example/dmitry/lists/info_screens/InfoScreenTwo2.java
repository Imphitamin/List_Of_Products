...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 2
 */
public class InfoScreenTwo2 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.alcatel_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.alcatel_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.alcatel_logo);

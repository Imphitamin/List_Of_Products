...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 8
 */
public class InfoScreenEight8 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.lenovo_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.lenovo_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.lenovo_logo);

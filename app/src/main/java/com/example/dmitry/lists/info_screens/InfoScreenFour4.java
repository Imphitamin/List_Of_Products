...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 4
 */
public class InfoScreenFour4 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.dns_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.dns_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.dns_logo);

...
/**
 * Created by Dmitry on 21.01.2015. Info Screen -> Number 5
 */
public class InfoScreenFive5 extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyName = getResources().getString(R.string.acer_company);
        mCompanySiteText = getResources().getString(R.string.go_to_company_site);
        mCompanySite = getResources().getString(R.string.acer_site);
        mCompanyLogo = getResources().getDrawable(R.drawable.acer_logo);
